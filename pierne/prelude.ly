...
\header {
dedication = \markup \center-align {
...
g16\mf_\markup { \hspace #'-10 \smaller \column {"G.O." "GREAT"}}^\markup \column {
\line \bold {\hspace #'-4 "Pas vite " \fontsize #'-2 \general-align #Y #DOWN \note #"4." #.8 "= 69"}
\italic "legato"}
