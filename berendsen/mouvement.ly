...
rightHand = \relative c' {
  ...
  <c e>4. <d g>4 | <e a>2. <a, d>4 | <c g'>4. <d a'> <g c>4 | <a d>1 |
  r4.  <c e>4. <b d>4 | <a c>4. <c, b'>4. <d g>4 |
  << {a'1~ | a} \\ \repeat unfold 2 {c,8 d16 c d8 c d16 c d8 c d }  >>
  % maat 25
  r4._\markup { \italic "più" \dynamic f }
  r r8 f | g1 | r4. r4 f8 f g | g1 |
  % maat 29
  ...
  d8\> e16 d e8 d f16 d f8 d e | d8 e16 d e8 d f16 d f8 d\pp e |
  d8 e16 d e8 d e16 d e8 d e | d8 e16 d e8 d e16 d e8 d e |
  d8 e16 d e8 d f16 d f8 d e | d8 e16 d e8 d e16 d e8 d e |
  % maat 45
  ...
  % maat 49
  \repeat unfold 3 {d8 d'16 d, d'8 d, d'16 d, d'8 d, d'8 } |
  d,8 d'16\> d,
  ...
  % maat 69
  d1~ | d2. r8 c, | d1~ | d4. r r4 |
  r4. c d4~ | d1~ | d2. r4 | r4. r4. \clef bass c,4 |
  d1 | R1 | R1 | r4. r r8 c |
  ...
  <f a> <g c>4 | <a d>2. <d, g>4 | <f c'>4. <g d'>\< \clef treble <c f>4 | <d g>2. r8 <f f'>\ff |
  % maat 93
  \stemUp <g g'>2. <a a'>8 <bes bes'> | <a a'>4 <g g'>8~ <g g'>4. r8 <f f'> |
  <g g'>2. <bes bes'>4 | <c c'>1 |
  \stemNeutral
...
leftHand = \relative c {
  ...
  % maat 41
  \clef treble
  r4. bes'8-.\p bes,-. r8 r4 | r4. a'8-. a,-. r8 r4 |
  r4. f'8-. f,-. r8 r4 | r4. e'8-. e,-. r8 r4 |
  r4. bes''8-. bes,-. r8 r4 | r4. a'8-. a,-. r8 r4 |
  r4. f'8-. f,-. r8 r4 | r4. e'8-. e,-. r8 r4 |
  r4. bes'8-. bes'-. r8 r4 | r4. a8-. a,-. r8 r4 |
  r4. f8-. f'-. r8 r4 | R1 |
  % maat 53
  r4. bes8\mp-. bes,-. r8 r4 | r4. a'8-. a,-. r8 r4 |
  r4. f'8-. f,-. r8 r4 | r4. e'8-. e,-. r8 r4 |
  % maat 57
  r4. bes''8-. bes,-. r8 r4 | r4. a'8-. a,-. r8 r4 |
  r4. f'8-. f,-. r8 r4 | r4. e'8-. e,-. r8 r4 |
  ...
  \clef treble
  % maat 105
  R1*2 | f''8-. r4 e8-. r4 r | c8-. r4 b8-. r4 r |
  r4. f'8-. f,-. r r4 | r4. e'8-. e,-. r r4 | r4. c'8-. c,-. r r4 | r4. b'8-. b,-. r r4 |
  r4. f''8-. f,-. r r4 | r4. e'8-. e,-. r r4 | r4. c''8-. c,-. r r4 | r4. b'8-. b,-. r r4 |
...
pedal = \relative c {
  \clef bass
  \global
  a8^\p r4 a8 r4 a8 r | a r4 a8 r4 r8 g(
  \repeat unfold 6 { a8) r4 a8 r4 a8 r | a r4 a8 r4 r8 g( }
  a8) r4 a8 r4 a8 r | a r4 a8 r4 r8 a( |
  g4) r8 g r4 r8 g( | fis) r4 fis8 r4 r8 fis( | e8) r4 e8 r4 r8 e( | d4) r8 d' r4 d,( |
  g4) r8 r4. r8 g | c,4 r8 r4 c'8 b4 | a2. r8 e' | d4 r8 d, r4 d'8 r |
  % maat 25
  R1 | r4. r d8 d, | R1 | r4. r4 d'8 d, e |
  f4 r8 r4. r8 f | b8 r4 r4. r8 b | f'8 r4 r4. f8 b | R1 |
  R1 * 20
  % maat 53
  bes,8(\mf bes') r r4. r4 | a,8( a') r r4. r4 |
  f,8( f') r r4. r4 | e,8( e') r r4. r4 |
  % maat 57, 61, 65
  \repeat unfold 3 {
    bes8( bes') r r4. r4 | a,8( a') r r4. r4 | f,8( f') r r4. r4 | e,8( e') r r4. r4 |
  }
  % maat 69
  bes8( bes') r r4. bes,4 | a8( a') r r4. a,4 | f8( f') r r4. f,4 | e8( e') r r4. e,4 |
  bes'4. r r4 | a4. r r4 | f4. r f4 | e4. r r4 |
  d8  r4 d8 r4 d8 r | d r4 d8 r4 r8 c( | d) r4 d8 r4 d8 r | d r4 d8 r4 r8 c( |
  d8) r4 d8 r4 d8 r | d r4 d8 r4 r8 c | d d' r8 r16 f,~-> f4 a4 | g8 r4 d'8 r4 r8 c,( |
  d8) r4 d8 r4 d8 r | d r4 d8 r4 r8 c | d d' r8 r16 f,~-> f4 a4 | g8 r4 g'8 r4 r8 d( |
  c4) r8 c r4 r8 c( | b) r4 b8 r4 r8 b( | a) r4 a8 r4 r8 a( | g4) r8 g' r4 d8 r |
  % maat 93
  ...
  % maat 105
  R1*8
  f,8( f') r r4. r4 | e,8( e') r r4. r4 | c8( c') r r4. r4 | b,8( b') r r4. r4 |
  f,8 f'16 f, f'8 f, f'16 f, f'8 f, f' | e,8 e'16 e, e'8 e, e'16 e, e'8 e, e' |
  c,8 c''16 c,, c''8 c,, c''16 c,, c''8 c, c' | b,8 b'16 b, b'8 b, b'16 a, a'8 <g, g'>-> r8 |
  % maat 121
  \repeat unfold 16 { f8 f'16 f, f'8 f, r4 r | }
  r4. r f'8 f, | r4. r f'8 f, |
  R1*3
}
